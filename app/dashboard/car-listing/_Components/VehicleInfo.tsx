    ...
    <div>
      ...
      >
        ...
        <p
          className={`text-[#777777] font-inter text-[10px] font-[400] leading-[14px] tracking-[0.4px] `}
        >
          {carFetched?.vehicleYear?carFetched?.vehicleYear :`N/A`}
        </p>
      </div>
      <div
        className={`py-[16px] border-b border-b-[#E2E2E2] flex flex-col gap-[8px]`}
      >
        ...
        <p
          className={`text-[#777777] font-inter text-[10px] font-[400] leading-[14px] tracking-[0.4px] `}
        >
          {carFetched?.vehicleCondition?carFetched?.vehicleCondition:`N/A`}
        </p>
      </div>
      <div
        className={`py-[16px] border-b border-b-[#E2E2E2] flex flex-col gap-[8px]`}
      >
        ...
        >
          {carFetched?.vehicleDescription?carFetched?.vehicleDescription:`N/A`}
        </p>
        {showMore ? (
          <Button
