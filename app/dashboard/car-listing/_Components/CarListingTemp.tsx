...
import { carListingTempType } from "@/types/carlisting";

const CarListingTemp = ({activeTab, setActiveTab, loading, vehicles}:carListingTempType) => {
  ...
  return (
    <div className={`h-full flex-grow flex-1 overflow-y-scroll noScroll `}>
      ...
      <div className={`flex flex-col gap-[24px]`}>
        {loading ? <div className={`py-[16px] flex items-center justify-between w-full border-b-[0.6px] border-[#C6C6C6]`}>
