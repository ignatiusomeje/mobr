...
import { useLazyGetAllBookingsByAUserQuery } from "../_Data/BookingAPI";
...
const CarInfo = ({
  ...
  const selectedBooking = useAppSelector((state) => state.bookings.currentBooking);
  ...
  return GetACarById ? (
    ...
    <div className={`max-w-[430px] w-full`}>
      ...
      <Button
        onClick={() => {
          GetAllBookingsByAUserTrigger({accountId: selectedBooking.customerId.toString()})
